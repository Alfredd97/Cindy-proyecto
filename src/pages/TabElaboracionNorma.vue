...
<template>
  <div class="q-pa-md">
      <q-page-sticky  position="bottom-right" :offset="[18, 18]">
        <q-btn fab icon="add" to="/elaboracion-norma" color="white" text-color="red-10"/>
      </q-page-sticky>
  ...
  <div class="q-pa-md">
  <q-page-sticky  position="right-top" :offset="[390, 10]"> 
    <q-markup-table :separator="separator" flat bordered>
      <thead>
        <tr>
          <th class="text-center">Nivel de la Norma</th>
          <th class="text-center">Título de la Norma</th>
          <th class="text-center">Responsable de la Elaboración</th>
          <th class="text-center">Elaboración del Anteproyecto</th>
          <th class="text-center">Terminación del Proyecto</th>
