...
<template>
  <div class="q-pa-md">
      <q-page-sticky  position="bottom-right" :offset="[18, 18]">
        <q-btn fab icon="add" to="/implantacion-norma" color="white" text-color="red-10"/>
      </q-page-sticky>
  ...
  <div class="q-pa-md">
  <q-page-sticky  position="right-top" :offset="[500, 10]">   
    <q-markup-table :separator="separator" flat bordered>
      <thead>
        <tr>
          <th class="text-center">Código DN</th>
          <th class="text-center">Título de Documento Normativo</th>
          <th class="text-center">Fecha de implantación de la Norma</th>
          <th class="text-center">Área en la cual será implantada</th>
