...
<template>
 <div class="q-pa-md">
      <q-page-sticky  position="bottom-right" :offset="[18, 18]">
        <q-btn fab icon="add" to="/materializacion-medio-a" color="white" text-color="red-10"/>
      </q-page-sticky>
  ...
  <div class="q-pa-md">
  <q-page-sticky  position="right-top" :offset="[480, 10]">  
    <q-markup-table :separator="separator" flat bordered>
      <thead>
        <tr>
          <th class="text-center">Acciones de la estrategia</th>
          <th class="text-center">Acciones para la materialización</th>
          <th class="text-center">Responsable</th>
          <th class="text-center">Participa</th>
          <th class="text-center">Controla</th>
        ...
        <tr>
          <th class="text-center">Indicadores de desempeño</th>
        </tr>
      </thead>
      <tbody>
      </tbody>
