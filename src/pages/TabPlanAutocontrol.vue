...
<template>
  <div class="q-pa-md">
      <q-page-sticky  position="bottom-right" :offset="[18, 18]">
        <q-btn fab icon="add" to="/plan-autocontrol" color="white" text-color="red-10"/>
      </q-page-sticky>
  ...
  <q-page-sticky  position="right-top" :offset="[600, 10]">   
    <q-markup-table :separator="separator" flat bordered>
      <thead>
        <tr>
          ...
          <th class="text-center">Ejecutante</th>
          <th class="text-center">Observaciones</th>
        </tr>
        <tr>
          <th class="text-center">Componente Ambiente de control</th>
        </tr>
        <tr>
