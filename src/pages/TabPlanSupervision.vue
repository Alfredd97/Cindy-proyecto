...
<template>
  <div class="q-pa-md">
      <q-page-sticky  position="bottom-right" :offset="[18, 18]">
        <q-btn fab icon="add" to="/plan-supervision" color="white" text-color="red-10"/>
      </q-page-sticky>
  ...
  <q-page-sticky  position="right-top" :offset="[570, 10]">   
  <div class="q-pa-md">
    <q-markup-table :separator="separator" flat bordered>
      <thead>
        <tr>
          <th class="text-center">Actividad de control</th>
